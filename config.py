...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        universe_fill_mode=_env_bool("UNIVERSE_FILL_MODE", True),
        micro_equity_threshold=float(os.getenv("MICRO_EQUITY_THRESHOLD", "10.0")),
        micro_equity_max_open=int(os.getenv("MICRO_EQUITY_MAX_OPEN", "99")),
        ...
        max_opens_per_tick=int(os.getenv("MAX_OPENS_PER_TICK", "99")),
        small_account_max_open=int(os.getenv("SMALL_ACCOUNT_MAX_OPEN", "99")),
        small_account_max_opens_per_tick=int(os.getenv("SMALL_ACCOUNT_MAX_OPENS_PER_TICK", "99")),
