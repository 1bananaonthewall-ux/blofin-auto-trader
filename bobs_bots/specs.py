"""Strategy specifications — shared period-trend edge; tiers differ by size + light gates."""
...
FAST_LANE = BotSpec(
    ...
    description="Max throughput period-trend 3R; loosest gates, highest size",
...
SCALPER_PRO = BotSpec(
    ...
    description="Period-trend 3R with soft runner bias; balanced throughput",
...
GOD_BOT = BotSpec(
    ...
    description="Period-trend 3R flagship; live relaxes gates when throughput starved",
...
ML_CORTEX = BotSpec(
    ...
    description="Period-trend 3R quality tier; tighter scores, conservative size",
