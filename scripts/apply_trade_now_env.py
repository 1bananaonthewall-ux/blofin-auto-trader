"""Enable throughput on micro accounts — margin-rate safety, not leverage caps."""
...
def main() -> None:
    ...
    ENV.write_text("\n".join(out) + "\n", encoding="utf-8")
    print("trade-now env:", ", ".join(sorted(UPDATES)))
